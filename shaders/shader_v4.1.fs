...
vec3 CalculateLight(Light light, vec3 N, vec3 V, vec3 albedo, float metallic, float roughness, samplerCube depthMap)
{
...
{		
    ...
    vec3 Lo = vec3(0.0);
    Lo += CalculateLight(light0, N, V, albedo, metallic, roughness, depthMap0);
    Lo += CalculateLight(light1, N, V, albedo, metallic, roughness, depthMap1);
